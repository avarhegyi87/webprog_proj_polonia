...
<form action = "?page=regisztral" method = "post">
	<fieldset>
		...
		<br>
		<input type="text" name="lastname" placeholder="vezetéknév" pattern="(?i)^(?:(?![×Þß÷þø])[-'0-9a-zÀ-ÿ])+$" required><br><br>
		<input type="text" name="firstname" placeholder="utónév" pattern="(?i)^(?:(?![×Þß÷þø])[-'0-9a-zÀ-ÿ])+$" required><br><br>
