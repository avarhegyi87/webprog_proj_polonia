<form action="?page=belep" method="post">
	<fieldset>
		...
		<input type="password" name="password" placeholder="jelszó"
			pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d\w\W]{8,}$" required><br><br>
...
<form action="?page=regisztral" method="post">
	<fieldset>
		...
		<br>
		<input type="text" name="lastname" placeholder="vezetéknév" pattern="(?i)^(?:(?![×Þß÷þø])[-'0-9a-zÀ-ÿ])+$"
			required><br><br>
		<input type="text" name="firstname" placeholder="utónév" pattern="(?i)^(?:(?![×Þß÷þø])[-'0-9a-zÀ-ÿ])+$"
			required><br><br>
		<input type="text" name="username" placeholder="felhasználói név" pattern="^[1-9a-zA-Z-_.]{3,}$"
			required><br><br>
		<input type="password" name="password" placeholder="jelszó"
			pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d\w\W]{8,}$" required><br><br>
